...
import classes.FolderTreeAnalyser;
...
public class FolderTreeAnalyserPanel extends JPanel
    ...
    private List <String> calculationResults = null; //список с результатами рассчета
     ...
     * mainFrame указатель на главный фрейм программы
     */
     ...
     * fileName имя файла, в который были сохранены результаты
     */
    private void showResultsDialog(List <String> results, String fileName) {
     ...
     * файла обработано.
     * f пророцент объема файла, который обработан на данный момент
     */

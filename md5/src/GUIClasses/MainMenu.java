...
public class MainMenu extends JMenuBar implements ActionListener,
    ...
    private java.util.List <ChangeLanguageListener> clListeners;
    ...
    public MainMenu(ResourceBundle messages) {
        ...
        clListeners = new java.util.ArrayList<ChangeLanguageListener> ();
    }

    /**
     * Этот метод выполняет обработку нажатий на пункты меню.
     * actionEvent объект, содержащий произошедшее событие
     */
     ...
     * mes текстовые строки на заданном языке, которые используются при создании интерфейса
     */
    ...
    private void setNewLanguage(ResourceBundle messages) {
        java.util.Iterator <ChangeLanguageListener> iter = clListeners.iterator ();
        while(iter.hasNext()) {
     ...
     * listener объект, реализующий интерфейс <CODE>ChangeLanguageListener</CODE>
     */

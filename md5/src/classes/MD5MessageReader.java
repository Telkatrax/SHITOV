...
public class MD5MessageReader {
     ...
     * f имя файла
     * java.io.IOException при возникновении ошибок работы с файлом
     */
     ...
     * java.io.IOException если возникли ошибки при работе с файлом исходных данных
     * новый блок данных в виде массива типа <CODE>int</CODE>,
    ...
    */
     ...
     * val число, которое нужно преобразовать

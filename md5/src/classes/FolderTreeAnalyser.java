...
public class FolderTreeAnalyser {
    ...
    private List <File>fileList = null; //список файлов
    private List <String>results = null; //список строк с результатами
    private List <MD5CalculatorStateListener>listeners = null; //список указателей на классы, которым нужна
    ...
    public FolderTreeAnalyser() {
        ...
        listeners = new ArrayList<MD5CalculatorStateListener>();
     ...
     * папки.
     * listener указатель на класс, которому нужна информация о процессе
     ...
     * List, содержащий строки с именами файлов и их MD5 суммами, если
     * расчет завершен успешно, null - в противном случае
     * IOException если возникли ошибки ввода-вывода
     */
    public List <String> analyse(String folderName) throws IOException {
     ...
     * basePath путь к заданной папке
